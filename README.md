# pyBybitMarketMaker
Simplified Bybit market maker for personal customisation. Responds to order fills. You need to set initial orders manually.

# Pre-requisites
Bybit account - https://www.bybit.com/app/register?ref=JQoVo
